...
\begin{sneltoetsen}
	\supertoetsdef{- \sterretje}{Systeemlettertype verkleinen}
	\supertoetsdef{= \sterretje}{Systeemlettertype vergroten}
\end{sneltoetsen}
\subsection{Firefox}
\begin{sneltoetsen}
...
\acc{SUPER} betekent de Windows toets.
\end{multicols}
\end{document}
