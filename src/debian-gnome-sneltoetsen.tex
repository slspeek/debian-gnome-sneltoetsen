...
%%
\documentclass[11pt,landscape,english]{article}
\usepackage{babel}
\usepackage{multicol}
\usepackage{calc}
\usepackage{ifthen}
...
\begin{sneltoetsen}
	...
	\sneltoetsdef{ALT+\`{}}{Venster wisselen van 1 toepassing}
	...
	\supertoetsdef{PgDn}{Meenemen naar volgend werkblad}
	\supertoetsdef{PgUp}{Vorig werkblad}
	\supertoetsdef{SHIFT+PgUp}{Meenemen naar vorig werkblad}
